...
// pathId. Across a value-only edit the pathId and the stable node id are both
// preserved, while the content-addressed nodeHash changes; pathIds are unique
// within a graph.
...
assert.equal(pathIdLiteralAfter.id, pathIdLiteralBefore.id, "stable node id is preserved across a value-only edit");
assert.notEqual(pathIdLiteralAfter.nodeHash, pathIdLiteralBefore.nodeHash, "content-addressed nodeHash changed after the edit");
